...
{{
  ...
  "contentHints": {{
    ...
    "before_badge": "<before_after_image: short uppercase badge label for the BEFORE panel, in the video's language — e.g. 'BEFORE' in English, 'AVANT' in French>",
    "after_badge": "<before_after_image: short uppercase badge label for the AFTER panel, in the video's language — e.g. 'AFTER' in English, 'APRÈS' in French>",
    ...
    "bnl_before_badge": "<before_now_later: BEFORE badge label in the video's language — e.g. 'BEFORE', 'AVANT'>",
    "bnl_now_badge": "<before_now_later: NOW badge label in the video's language — e.g. 'NOW', 'MAINTENANT'>",
    "bnl_later_badge": "<before_now_later: LATER/AFTER badge label in the video's language — e.g. 'AFTER', 'APRÈS'>",
...
card density as structured coaching — a well-phrased thought in a stream is just as valid as a
