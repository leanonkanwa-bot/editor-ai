...
(function (root) {
  ...
  var TRANSLATIONS = {
    fr: {
      ...
      demo_after_caption: "Captions · graphics synchronisés",
      ...
      feat7_desc: "YouTube et TikTok favorisent les vidéos en haute résolution. Exporte en 4K natif et laisse l’algorithme faire le reste.",
      pricing_anchor: "Un monteur freelance facture entre 50 € et 150 € de l’heure. LeanRetention coûte moins qu’une seule session et traite ta vidéo en 8 minutes.",
      founder_quote: "J’ai construit LeanRetention parce que je cherchais quelque chose qui n’existait pas : un outil qui comprend vraiment la rétention vidéo, pas juste le montage. Je l’utilise encore chaque semaine pour mes propres vidéos.",
      founder_name: "KAN, Fondateur de LeanRetention",
      founder_role: "Créateur de contenu · Stratégiste rétention",
      // ── PRICING ──────────────────────────────────────────────────────────────
      pricing_tag: "Tarifs",
      ...
      faq3_answer: "En général entre 3 et 15 minutes selon la durée de ta vidéo. Tu reçois une notification par email dès que c'est prêt — tu n'as pas besoin de rester sur la page.",
    ...
    en: {
      ...
      demo_after_caption: "Captions · synced graphics",
      ...
      feat7_title: "Export 4K",
      feat7_desc: "YouTube and TikTok favor high-resolution videos in their algorithm. Export in native 4K and let the algorithm do the rest.",
      ...
      faq3_answer: "Usually between 3 and 15 minutes depending on your video length. You get an email notification as soon as it is ready so you do not have to stay on the page.",
